export const translations = {
    es: {
        ...
        hero: {
            greeting: '> hola, soy',
            subtitle: 'Transformando ideas en aplicaciones web impactantes con tecnologías modernas que cautivan, conectan y entregan resultados.',
            viewProjects: 'Ver Proyectos',
            contact: 'Contactar',
            scroll: 'SCROLL',
            roles: {
                java: 'Desarrollador Java Jr',
        ...
        about: {
            ...
            description: 'Un desarrollador apasionado por el código limpio y el crecimiento constante.',
            highlights: {
                location: 'Ubicación',
                education: 'Educación',
                ...
                availValue: 'Inmediata | Jornada completa',
    ...
    en: {
        ...
        hero: {
            greeting: "> hi, I'm",
            subtitle: 'Transforming ideas into impactful web applications with modern technologies that captivate, connect, and deliver results.',
            viewProjects: 'View Projects',
            contact: 'Contact Me',
            scroll: 'SCROLL',
            roles: {
                java: 'Java Developer Jr',
        ...
        about: {
            title: 'About Me',
            subtitle: 'My Story',
            description: 'A developer passionate about clean code and constant growth.',
            highlights: {
                location: 'Location',
                education: 'Education',
                ...
                availValue: 'Immediate | Full time',
                langValue: 'Spanish (Native) | English B2',
            },
            bio: [
                '20-year-old software developer with a Full Stack foundation and growing focus on backend development with Java and Spring Boot. I focus on code quality, technical documentation, and collaborative work in agile teams.',
                'I am disciplined, a fast learner, and easily adapt to new technologies and methodologies. I am looking for a first formal experience where I can apply my knowledge, add value from day one, and continue to grow continuously.',
                'I focus on creating robust, scalable, and well-documented solutions, always maintaining a balance between frontend aesthetics and backend efficiency.',
            ],
        },
        skills: {
            title: 'Skills',
