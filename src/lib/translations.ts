export const translations = {
    es: {
        ...
        about: {
            ...
            bio: [
                'Soy un desarrollador fullstack enfocado en ecosistemas Java/Spring Boot y arquitecturas modernas. Disfruto desentramando complejidad técnica para entregar productos estables.',
        ...
        projects: {
            ...
            items: {
                ...
                port: {
                    ...
                    impact: 'Experiencia de usuario instantánea y posicionamiento como perfil de Desarrollo de Producto.',
                }
            }
        },
        experience: {
    ...
    en: {
        ...
        about: {
            ...
            bio: [
                'I am a Fullstack Developer focused on Java/Spring Boot ecosystems and modern architectures. I enjoy unraveling technical complexity to deliver stable products.',
        ...
        projects: {
            ...
            items: {
                ...
                port: {
                    ...
                    impact: 'Instant user experience and strong positioning as a Product Development profile.',
                }
            }
        },
        experience: {
